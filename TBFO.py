...
#        Hygiene3 = Hygiene2 + Hygiene1
#        Energy3 = Energy2 + Energy1
#        Fun3 = Fun2 + Fun1
    else:
        print ("Aksi Tidak Valid")
        print ("Hygiene = " + str(Hygiene2-Hygiene1))
        print ("Energy  = " + str(Energy2-Hygiene1))
        print ("Fun     = " + str(Fun2-Hygiene1))
    ...
    if((((Hygiene==15) and (Energy==15) and (Fun==15))):
        ...
        while((play!='Y') and (play!='N'))
            if (play == 'Y'):
                ...
                print("mohon ulangi pilihan kamu! (Y/N)" )
